...
Для работы данному боту нужен доступ к API hh, получение доступа несколько замороченная процедура и может занимать несколько дней, однако в итоге вы получите стабильно работающее и абсолютно легальное приложение для автоматических откликов, так что игра стоит свеч.
