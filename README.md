...
4. Установите постоянную ссылку на группу, например t.me/linkedin_bot_feedback.

5. Установите TG_CHAT_ID в `config/app_config.py` с этой ссылкой, например TG_CHAT_ID = "@linkedin_bot_feedback"

6. Создайте две темы: одну для ошибок и другую для отчетов

7. Отправьте сообщение в каждую тему в чате. Затем нажмите на это сообщение и выберите *Копировать ссылку на сообщение*. Вы получите ссылку вида: https://t.me/c/194xxxx987/11/13, где ID темы группы равен 11. Установите TG_ERR_TOPIC_ID в `config/app_config.py` с ID темы ошибок и TG_REPORT_TOPIC_ID - с ID темы отчетов.
